(function() {
  ...
  FishTankRenderer.prototype.onWindowResize = function() {
  ...
  FishTankRenderer.prototype.render = function(controlX, controlY) {
    ...
    this.camera.position.x += ( - controlX - this.camera.position.x ) * .05;
    this.camera.position.y += ( - controlY - this.camera.position.y ) * .05;
